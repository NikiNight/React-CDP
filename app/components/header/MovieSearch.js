            ...
            <div className="movie-search">
                ...
                <div className="movie-search__buttons-line">
                    <div className="movie-search__buttons">
                        <span>Search by</span>
                        <SearchByButton isActive={this.state.searchBySelected=='Title'} value='Title' toggleButtonsState={this.toggleButtonsState} />
                        <SearchByButton isActive={this.state.searchBySelected=='Genre'} value='Genre' toggleButtonsState={this.toggleButtonsState} />
                    </div>
